		...
		return (
			<Card className='bg-white border-blue-100 shadow-xl shadow-blue-900/5 animate-in fade-in zoom-in duration-300 relative overflow-hidden'>
				...
				<CardContent className='flex flex-col items-center justify-center p-8 text-center relative z-10'>
					...
					<h3 className='text-2xl font-bold text-slate-900 mb-2'>Zgłoszenie przyjęte</h3>
					<p className='text-slate-600 mb-8 max-w-md text-sm leading-relaxed'>
						Pakiet Premium (Case Study + Certyfikaty) został wysłany na Twój adres e-mail.
						<br />
					...
					<div className='bg-slate-50 p-5 rounded-xl border border-slate-200 w-full shadow-inner mb-6'>
						...
						<a
							...
							<div>
								...
								<p className='text-[10px] text-slate-500'>PDF • 2.4 MB • Pobierz teraz</p>
							</div>
						</a>
						...
						<div className='mt-3 flex items-center gap-3 p-3 rounded-lg border border-slate-200 bg-slate-100/50 text-left'>
							...
							<div>
								<p className='font-medium text-slate-500 text-sm'>Pakiet Premium (Case Study + ISO + Linki)</p>
								<p className='text-[10px] text-green-600 font-bold flex items-center gap-1'>✓ Wysłano na e-mail</p>
							</div>
						</div>
					</div>
			...
			<form onSubmit={onSubmit}>
				<div className='grid grid-cols-1 md:grid-cols-2 gap-6 mb-6'>
					<div className='space-y-2'>
						...
						<Input id='name' name='name' required className='bg-slate-50 border-slate-200 text-slate-700' />
					</div>
					<div className='space-y-2'>
						<Label htmlFor='company' className='text-slate-700 font-medium'>
							Nazwa Firmy
						</Label>
						<Input id='company' name='company' required className='bg-slate-50 border-slate-200 text-slate-700' />
					</div>
				</div>
				...
				<div className='space-y-2 mb-8'>
					...
					<Textarea id='message' name='message' className='bg-slate-50 border-slate-200 min-h-[100px] text-slate-700' />
				</div>
				...
				<p className='text-[10px] text-slate-400 mt-6 text-center leading-tight max-w-lg mx-auto'>
					Administratorem Twoich danych osobowych jest Brezit Bartosz Rezmer. Przesyłając formularz, akceptujesz
